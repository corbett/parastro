...
*/
int vtkSQLiteReader2::RequestDataDemo(vtkInformationVector* outputVector)
{
...
Sets up an SQL Query
	...
	returns:
		int	errorcode (1 =ok)
*/
int vtkSQLiteReader2::SQLQuery(vtkStdString sql_query, sqlite3_stmt * res)
{
	const char      *tail;		// ???
	int				sql_error;	// return value of sql query
...
Finds the collision and merging Points
	...
	returns:
		int errorcode
*/
int vtkSQLiteReader2::findCollisions(CollisionCalculationStruct* pCollCalc){
...
assumes:
	...
	returns:
		int errorcode
*/
int vtkSQLiteReader2::generateSelection(CollisionCalculationStruct * collCalc, SelectionStruct* select)
{
